...
output_dir='/media/hmi/Transcend/photoface_ft_512_checkpoints/training_logs'
output_valid_dir='/media/hmi/Transcend/photoface_ft_512_checkpoints/validation_results'
