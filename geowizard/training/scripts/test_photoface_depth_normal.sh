...
output_valid_dir='/media/hmi/Transcend1/geowizard_checkpoints_validation_mask/validation_results'
pretrained_model_name_or_path="stabilityai/stable-diffusion-2"
fined_tune_from_checkpoint='/media/hmi/Transcend1/geowizard_photoface_checkpoints_mask_v2/training_logs/checkpoint-3000'
